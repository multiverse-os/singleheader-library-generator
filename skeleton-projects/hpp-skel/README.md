# Skeleton for C++ header-only library
A skeleton for C++ libraries that can be included into other  C++ projects. 

**This repository itself is a helper library.** 

## Usage
*To use it for a specific project, edit filenames and tests accordingly.*
